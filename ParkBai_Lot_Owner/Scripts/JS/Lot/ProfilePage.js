...
$(function () {
    ...
    $(".Ppicupload").on("click", function (event) {
    ...
    function GetName() {
        onValue(ParkLotRef, (snapshot) => {
            ...
            if (NameData) {
                $("#Comp_name").text(NameData.Company.toUpperCase() || "Loading...");
    ...
    function GetAccount() {
        onValue(AccountRef, (snapshot) => {
            ...
            if (AccountData) {
                var Name = AccountData.First_Name + " " + AccountData.Middle_Name + " " + AccountData.Last_Name;
                $("#Email").text(AccountData.Email || "Loading...");
                $("#Name").text(Name.toUpperCase() || "Loading...");
    ...
    function GetIncome() {
        get(IncomeRef).then((snapshot) => {
            ...
            if (snapshot.exists()) {
                $("#currentBalance").text(IncomeData.Current_Balance.toFixed(2) || "Loading...");
                $("#totalIncome").text(IncomeData.Total_Income || "Loading...");
            } else {
